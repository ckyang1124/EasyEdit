...
- Then, you can run the codes to evaluate the performance of different methods on the SAKE benchmark:
  - For codes to run "WISE" and "UnKE", please refer to the folder `unke_wise/` in this repository.
  - For codes to run other methods, please refer to `lalm_edit.py` file.
